...
func (s *FriendStorage) AddFriend(ctx context.Context, userID, friendID int64) error {
...
func (s *FriendStorage) DeleteFriend(ctx context.Context, userID, friendID int64) error {
	_, err := s.dbRouter.Exec(ctx,
